...
type content_type = Http.Core.content_type = Html | Json | Pdf
...
val equal_content_type :
  content_type -> content_type -> Ppx_deriving_runtime.bool
...
val pp_header :
  Ppx_deriving_runtime.Format.formatter -> header -> Ppx_deriving_runtime.unit
...
val pp_headers :
  Ppx_deriving_runtime.Format.formatter -> headers -> Ppx_deriving_runtime.unit
