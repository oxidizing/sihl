...
module Session =
  Test_common.Test.Session.Make (Service.Database) (Service.Repo)
    (Service.Session)
module Storage =
  Test_common.Test.Storage.Make (Service.Database) (Service.Repo)
    (Service.Storage)
module User =
...
module PasswordReset =
  Test_common.Test.PasswordReset.Make (Service.Database) (Service.Repo)
    (Service.User)
    (Service.PasswordReset)
module Queue = Test_common.Test.Queue.Make (Service.Repo) (Service.Queue)
module Csrf =
  Test_common.Test.Csrf.Make (Service.Database) (Service.Repo) (Service.Token)
    (Service.Session)
    (Service.Random)
