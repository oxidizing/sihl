...
(** Checks whether the [claim] of the token [t] is in the past by looking at [now]. If no
    exp claim was not found the token can not expire and [is_expired] returns true. A
