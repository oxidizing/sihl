...
val create_and_add_to_ctx : ?body:string -> ?uri:string -> Core.Ctx.t -> Core.Ctx.t
val accepts_html : Core.Ctx.t -> bool
val require_authorization_header : Core.Ctx.t -> (Cohttp.Auth.credential, string) result
...
val urlencoded2 : Core.Ctx.t -> string -> string -> (string * string) option Lwt.t
...
val param3 : Core.Ctx.t -> string -> string -> string -> (string * string * string) option
