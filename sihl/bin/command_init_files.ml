...
let env_base db =
  let database_url =
    match db with
    | Sihl.Config.Postgresql -> "postgresql://admin:password@127.0.0.1:5432/dev"
    | Sihl.Config.Mariadb -> "mariadb://admin:password@127.0.0.1:3306/dev"
  in
  let random_secret =
