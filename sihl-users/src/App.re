...
module Http = {
  let routes = database => [
    ...
    Routes.RequestPasswordReset.endpoint(Settings.namespace, database),
    Routes.ResetPassword.endpoint(Settings.namespace, database),
    Routes.UpdatePassword.endpoint(Settings.namespace, database),
    Routes.SetPassword.endpoint(Settings.namespace, database),
    Routes.UpdateUserDetails.endpoint(Settings.namespace, database),
