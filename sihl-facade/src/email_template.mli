...
val set_label : string -> Sihl_contract.Email_template.t -> Sihl_contract.Email_template.t
val set_text : string -> Sihl_contract.Email_template.t -> Sihl_contract.Email_template.t
...
val register : (module Sihl_contract.Email_template.Sig) -> Sihl_core.Container.Service.t
